...
description: Simplify code for clarity and maintainability — reduce complexity without changing behavior. Use when the user explicitly invokes /code-simplify.
---
